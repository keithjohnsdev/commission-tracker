...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference("Agency.count") do
      post agencies_url, params: { agency: { default_commission_rate: @agency.default_commission_rate, iata_number: @agency.iata_number, name: @agency.name } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { default_commission_rate: @agency.default_commission_rate, iata_number: @agency.iata_number, name: @agency.name } }
